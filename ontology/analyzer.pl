:- include('C:/Users/asus/PycharmProjects/chatbott/weak_vowel_harmonizer.pl').
...
allomorph(zaman,noun).
allomorph(vakit,noun).
allomorph(meydan,noun).
allomorph(zafer,noun).
allomorph(adü,noun).
allomorph(zafermeydaný,noun).
